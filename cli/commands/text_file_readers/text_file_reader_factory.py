...
from cli.commands.text_file_readers.extensions.docx_file_reader import DocxFileReader
from cli.commands.text_file_readers.extensions.txt_file_reader import TxtFileReader
