...
from cli.commands.text_file_readers.text_file_reader import TextFileReader
from cli.commands.base_command import BaseCommand
from cli.commands.to_speech_converter.to_speech_converter import ToSpeechConverter
from cli.directories import SCRIPT_DIR
from cli.user_interface.interface_definition import INPUT_OPTION, NAME_OPTION, OUTPUT_OPTION
