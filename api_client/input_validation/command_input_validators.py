...
COMMAND_INPUT_VALIDATORS: Dict[CommandId, InputValidatorInterface] = {
    ...
    CommandId.GET_DEFAULT_VOICE_SETTINGS: InputValidatorInterface(),
    CommandId.GET_VOICE_SETTINGS: InputValidatorInterface(),
    CommandId.GET_VOICE: InputValidatorInterface(),
    CommandId.DELETE_VOICE: InputValidatorInterface(),
