...
class ElevenLabsApi:
    def __init__(self, api_key: str, input_validator_interface: InputValidator,
                 url_builder: UrlBuilderInterface, params_builder: ParamsBuilderInterface,
                 request_handler: RequestHandlerInterface, response_handler: ResponseHandlerInterface):
        self.__api_key: str = api_key
        self.__input_validator: InputValidator = input_validator_interface
    ...
    def __handle_request(self, command_id: CommandId, request_code: RequestCode, **kwargs) -> Any:
        ...
        url: str = self.__url_builder.build(command_id)
