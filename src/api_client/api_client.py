...
from src.common.voice.voice import Voice, VoiceID
...
class ApiClient:
    ...
    def text_to_speech(self, voice_id: str, text: str, stability: float = 0.75, similarity_boost: float = 0.75,
                       model_id: ModelId = ModelId.MONOLINGUAL,
        ...
        return self.__handle_request(CommandId.TEXT_TO_SPEECH, voice_id=voice_id, text=text, model_id=model_id.value,
                                     stability=stability, similarity_boost=similarity_boost, latency=latency.value)
