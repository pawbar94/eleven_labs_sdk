from eleven_labs_api.requests.exceptions.empty_sample_id import EmptySampleId
...
class DeleteSampleRequest(RequestInterface):
    ...
    def uri(self) -> str:
        return f'/v1/voices/{self.__voice_id}/samples/{self.__sample_id}'
